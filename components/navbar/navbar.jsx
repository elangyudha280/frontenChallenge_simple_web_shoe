   ...
   <nav className="relative w-full p-3 border-b-2 border-b-slate-100">
    <div  className="max-w-6xl relative mx-auto  flex items-center justify-between flex-wrap gap-2  max-[320px]:flex-col">
        ...
        <div className="relative max-[320px]:flex-1 max-[320px]:w-full">
            {/* //! button card */}
            <Link href={`/order`} type='button' className=" flex gap-2 flex-wrap justify-center items-center py-1.5 px-4 font-semibold border-2 border-custom-black-800 rounded-md transition-all duration-200 max-[320px]:w-full hover:bg-custom-black-800 hover:ring-0 hover:text-white">
                <BiShoppingBag/>
